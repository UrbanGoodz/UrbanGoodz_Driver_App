...
import 'package:urban_goodz_driver/screens/load_board_screen.dart';
import 'package:urban_goodz_driver/screens/opportunities_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final DispatchNotificationController dispatchCtl = Get.put(
              ...
              child: GestureDetector(
                ...
                child: Stack(
                  children: [
                    ...
                    Obx(
                      () => dispatchCtl.unreadCount.value > 0
                          ? Positioned(
                              right: 0,
                              top: 0,
                              child: Container(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Get.to(() => const ActiveJobsScreen()),
                    child: const Text(
                      'See All',
              ...
              Row(
                ...
                children: [
                  _QuickAction(
                    ...
                    label: 'Load Board',
                    color: AppTheme.primary,
                    onTap: () => Get.to(() => const LoadBoardScreen()),
                  ),
                  _QuickAction(
                    icon: Icons.star_outline,
                    label: 'Opportunities',
                    color: AppTheme.accent,
                    onTap: () => Get.to(() => const OpportunitiesScreen()),
                  ),
                  _QuickAction(
                    icon: Icons.badge,
                    label: 'Certs',
        ...
        child: Column(
          ...
          children: [
            ...
            _profileNavTile(
              ...
              () => Get.to(() => const VehicleRequirementsScreen()),
            ),
            _profileNavTile(
              context,
              Icons.settings,
              'Capability Profile',
              () => Get.to(() => const CapabilityScreen()),
            ),
            _profileNavTile(
              context,
            ...
            _profileNavTile(
              ...
              Icons.map,
              'Route Details',
              () => Get.to(() => const RouteDetailsScreen(jobId: '0')),
            ),
            _profileNavTile(
              context,
              Icons.work_outline,
              'Load Board',
              () => Get.to(() => const LoadBoardScreen()),
            ),
            _profileNavTile(
              context,
              Icons.star_outline,
              'Opportunities',
              () => Get.to(() => const OpportunitiesScreen()),
            ),
  ...
  Widget _profileNavTile(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: const Icon(Icons.chevron_right, color: AppTheme.dark),
        onTap: onTap,
      ),
    );
  }
